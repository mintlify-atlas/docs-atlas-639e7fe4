---
title: "GymSys Architecture: Frontend and API Overview"
sidebarTitle: "Architecture"
description: "Understand how GymSys separates the React frontend from the REST API backend and how the services/api.js module bridges them."
---
